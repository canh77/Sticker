...
public abstract class AddStickerPackActivity extends BaseActivity {
    private static final int ADD_PACK = 201;
    ...
    protected void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
        try {
            ...
            if (!stickerPackWhitelistedInWhatsAppConsumer && !stickerPackWhitelistedInWhatsAppSmb) {
                ...
                launchIntentToAddPackToChooser(identifier, stickerPackName);
                Log.d("012345678998745", "launchIntentToAddPackToChooser " +identifier  + " stickerPackName " + stickerPackName);
            }
        } catch (Exception e) {
    ...
    private Intent createIntentToAddStickerPack(String identifier, String stickerPackName) {
        ...
        intent.putExtra(AddStickerPackActivity.EXTRA_STICKER_PACK_AUTHORITY, BuildConfig.CONTENT_PROVIDER_AUTHORITY);
        intent.putExtra(AddStickerPackActivity.EXTRA_STICKER_PACK_NAME, stickerPackName);
        Log.d("01234567899874", "createIntentToAddStickerPack:  name  " + stickerPackName + "    identifier " +identifier);
        return intent;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ADD_PACK) {
            Log.d("01234567899874", "requestCode: "+requestCode + "ADD_PACK " + ADD_PACK);
    ...
    public static final class StickerPackNotAddedMessageFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(getActivity())
                    ...
                    .setNeutralButton(R.string.app_name, (dialog, which) -> launchWhatsAppPlayStorePage());
