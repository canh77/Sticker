package com.lutech.stickerwhatsapp.provider;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final String CONTENT_FILE_NAME = "sticker.json";

    public static final String CONTENT_SCHEME = "sticker";
    private static final String TAG = StickerContentProvider.class.getSimpleName();
    public static Uri AUTHORITY_URI = new Uri.Builder()
            .scheme(StickerContentProvider.CONTENT_SCHEME).authority(BuildConfig.CONTENT_PROVIDER_AUTHORITY)
